...
def parse_opt():
    ...
    parser.add_argument('--data', default=r'D:/User/Desktop/ultralytics/data/seg')  # 数据集路径
...
def main(opt):
    ...
    for label in labels:
        ...
        for l in lines:
            ...
            coordinates = l.split(' ')[1:]
            lbl_counter[category] += 1
...
if __name__ == "__main__":
    ...
    model = YOLO('D:/User/Desktop/ultralytics/checkpoint/temp-seg.pt', task='train')
    # 从文本文件中加载内容并存储到一个列表中
    ds_yamls = []
