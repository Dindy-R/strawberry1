...
class YoLov8TRT(object):
    ...
    def __init__(self, engine_file_path):
        ...
        with open(engine_file_path, "rb") as f:
            # read_engine=f.read()
            # print(read_engine.type)
            engine = runtime.deserialize_cuda_engine(f.read())
        if engine==None:
            print("[E] Engine file not loaded")
        ...
        self.seg_c = int(self.seg_output_length / (self.seg_w * self.seg_h))
        self.det_row_output_length = self.seg_c + DET_NUM + POSE_NUM

        # Draw mask
        self.colors_obj = Colors()
        print("det_row_out_len is: "+str(self.det_row_output_length))
    ...
    def infer(self, raw_image_generator):
        ...
        return boxes, scores, classid, batch_image_raw[0],result_masks
...
if __name__ == "__main__":
    ...
    PLUGIN_LIBRARY = "yolov8_caomei/libmyplugins.so"
